package com.uth.pm1e2grupo2.adaptadores;
...
import com.uth.pm1e2grupo2.R;
import com.uth.pm1e2grupo2.VerActivity;
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("ID", String.valueOf(listaContactos.get(getAdapterPosition()).getId()));
